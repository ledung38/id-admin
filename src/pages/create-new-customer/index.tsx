...
export const CreateNewCustomer = () => {
  ...
  const createCustomerMutation = useMutation({
    mutationFn: (params: any) => customerAPI.createCustomer(params),
  ...
  const setAvengerHeight = async () => {
    if (formik.values.gender === Gender.Male) {
      await formik.setFieldValue('height', 165);
      return;
    }
    if (formik.values.gender === Gender.Female) {
      await formik.setFieldValue('height', 153);
      return;
    }
  };
